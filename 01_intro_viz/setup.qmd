---
title: Setting up Keaton C Green Viz
format: gfm
---

This notebook should confirm that you have the packages you need to get started for the class. Run code chunks individually, then render the notebook, either by pressing a button (if in RStudio), choosing the render command (if in Positron), or calling the quarto CLI (`quarto render 01a_intro_viz/setup.qmd`).

If this runs successfully, you should have:
...
This blocks function is pulling the utils from the intro viz directory.
